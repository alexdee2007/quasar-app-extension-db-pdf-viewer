...
function extendConf(conf) {
  ...
  conf.boot.push('~quasar-app-extension-db-pdf-viewer/src/boot/register-db-pdf-viewer.js')

  // make sure boot & component files get transpiled
  conf.build.transpileDependencies.push(/quasar-app-extension-db-pdf-viewer[\\/]src/)
